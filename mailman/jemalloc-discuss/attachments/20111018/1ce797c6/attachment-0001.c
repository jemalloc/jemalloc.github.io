...
/* Toku hack to single-thread mallocator */
static malloc_mutex_t	single_thread_lock =
#ifdef JEMALLOC_OSSPIN
    0
#else
    MALLOC_MUTEX_INITIALIZER
...
#  endif
	...
	malloc_mutex_lock(&single_thread_lock);
...
RETURN:
	...
	malloc_mutex_unlock(&single_thread_lock);
	return (ret);
}
...
JEMALLOC_ATTR(visibility("default"))
void
JEMALLOC_P(malloc_stats)(void)
{
        stats_print(NULL, NULL, NULL);
}
